...
class RegexPratctice43 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("cat".matches("[cC]at")); // matches()  => compare 2 string return un boolean | [cC] => tout ce qui contiend c ou C majuscule en 1ere lettre (à cette position)
