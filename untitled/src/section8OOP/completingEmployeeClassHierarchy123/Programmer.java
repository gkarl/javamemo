 ...
 *
 * - Java on ne peux extends (hériter) que d'1 seul class (mére)
 * - Java permet d'implementer multi interface sur une class
 *
 */
class Programmer extends Employee {  //** extends Employee => la class Programmer hérite de la super class Employee, les propriétés et les méthodes présent super classe sont héritées tant qu’ils sont au moins protected ou public | c'est toujours dire qu'un Programmeur est un type Employee
