 ...
 *
 * On a la class CEO qui hérite de la super class Employee mais on voudrait que CEO hérite aussi de la class Pilot
 ...
 * => thechnique de composition
 *
 */

// La Class Employee doit implémenté l'interface IEmployee pour que la methode createEmployee puisse l'utiliser comme type de return
