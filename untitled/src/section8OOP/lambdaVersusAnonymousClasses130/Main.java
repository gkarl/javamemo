 ...
 *
 * On a un probléme quand lance programme sur la data ligne 2 ou on a fait expret de faire une erreur de frappe sur le role Programmerzzzzzzz pour entrer dans le case default du switch
 * => lance la Lambda
 * => return juste un int
 * => getSalary() marche
 * => mais pas toString() qui par défault affiche un truc comme ça
 * => section8OOP.lambdaVersusAnonymousClasses130.Employee$$Lambda$40/0x0000000800c03000@7eda2dbb
 */
class Main {
