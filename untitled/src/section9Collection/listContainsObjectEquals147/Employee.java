...
abstract class Employee implements IEmployee {// abstract class => on ne veut permettre a personnes d'instancier une abstract class | flag pour dire qu'il y aura une abstract methode qui devra etre implementé par les class filles
    ...
    //Etape 2_____________ Alt Insert / equals() et hashCode() => IDE les Override pour nous | choisir les fields qui identifie une personnes on garde les meme pour les 2 methodes | pour not null on coche tous les fields => on ne veux pas qu'un de ces fields puissent etre null à instanciation d'un Employee
    @Override
