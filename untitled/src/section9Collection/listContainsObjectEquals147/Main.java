...
/**
 * Section 9 Collection - 146 List.contains() & Object.equals()
 *
 * Une variable contiend l'adresse qui pointe vers un objet
 * Pour pouvoir établir une égalité entre ces 2 variables qui ont le meme contenu il faut override les methode equals() et hashCode()
 * Alt Insert / equals() et hashCode() => IDE les Override pour nous
 * faire très attention à choisir les champs qui sont peu susceptibles de changer dans de nombreux cas.
 * EX Pour différencier 2 personnes on va utiliser les fields firstName, lastName, dob
 *
 * il faut utiliser cette technique pour bcp de méthodes de List interface :
 * - contains()
 * - indexOf()
 * - lastIndexOf()
 * - remove()
 * - removeAll()
 * (toutes ces methodes ont besoin de la methode equals() pour fonctionner)
 *
 */
class Main {
